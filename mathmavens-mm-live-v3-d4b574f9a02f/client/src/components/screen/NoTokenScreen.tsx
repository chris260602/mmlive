...
export default function NoTokenScreen() {
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg border border-gray-200">
        <div className="p-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Oops! Something’s Missing</h1>
          <p className="text-gray-600 mb-6">We couldn’t find a valid access token. Please check your link or request a new one.</p>
        </div>
